...
# 	with open("noise_datasets/noise2_"+str(p)+"_edges.dump", "wb") as fp2:   #Pickling
...
# 	with open("noise_datasets/noise1_"+str(p)+"_edges.dump", "wb") as fp2:   #Pickling
# 		pickle.dump(edges,fp2)

# p=15
name="noise_datasets/noise2_"+str(p)+"_edges"
with open("noise_datasets/noise2_"+str(p)+"_edges.dump", "rb") as fp2:   #Pickling
		ed = pickle.load(fp2)
